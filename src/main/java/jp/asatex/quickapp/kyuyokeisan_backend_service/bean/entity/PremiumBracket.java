 ...
 * 用于2025年神奈川县社会保险费等级表，用于健康保险、厚生年金保险的计算
 */
...
public class PremiumBracket {
    ...
    // 全参构造函数（用于流式构建）
    public PremiumBracket(Long id, String grade, Integer stdRem, Integer minAmount, 
                          Integer maxAmount, BigDecimal healthNoCare, BigDecimal healthCare, 
                          BigDecimal pension, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.grade = grade;
        this.stdRem = stdRem;
