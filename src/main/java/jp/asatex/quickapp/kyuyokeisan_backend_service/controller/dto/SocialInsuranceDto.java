...
public class SocialInsuranceDto {
    ...
    public static class EmployeeCost {
        ...
        public EmployeeCost withHealthCostWithNoCare(BigDecimal healthCostWithNoCare) {
            return new EmployeeCost(healthCostWithNoCare, this.careCost, this.pension);
        }

        public EmployeeCost withCareCost(BigDecimal careCost) {
            return new EmployeeCost(this.healthCostWithNoCare, careCost, this.pension);
        }

        public EmployeeCost withPension(BigDecimal pension) {
            return new EmployeeCost(this.healthCostWithNoCare, this.careCost, pension);
        }
    ...
    public static class EmployerCost {
        ...
        // 流式编程风格的 with 方法，返回新实例（不可变风格）
        public EmployerCost withHealthCostWithNoCare(BigDecimal healthCostWithNoCare) {
            return new EmployerCost(healthCostWithNoCare, this.careCost, this.pension);
        }

        public EmployerCost withCareCost(BigDecimal careCost) {
            return new EmployerCost(this.healthCostWithNoCare, careCost, this.pension);
        }

        public EmployerCost withPension(BigDecimal pension) {
            return new EmployerCost(this.healthCostWithNoCare, this.careCost, pension);
        }
